<%-- 
    Document   : jugadorlogin
    Created on : May 29, 2018, 11:00:16 AM
    Author     : AGutierrez
--%>
	...
	<div class="new">
		<div class="container">
			<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
				<h3 class="title"><span>Ingresa al sistema!</span></h3>
...
<div class="address1"><!--address-->
	...
	<div class="col-md-6 address-right">
					<div class="address-info wow fadeInRight animated" data-wow-delay=".5s">
												<h4 class="wow fadeIndown animated" data-wow-delay=".5s">Escribe tu cuenta</h4>
												<style>
