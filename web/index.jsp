<%-- 
    Document   : index
    Created on : May 30, 2018, 10:37:37 AM
    Author     : AGutierrez
--%>
...
<header id="header">
	...
	<!--banner-->
			...
			<ul id="slippry">
    <li>
      <a href="#slide1"><img src="images/portada.jpg" alt="BIENVENIDO!"></a>
    </li>
    <li>
      <a href="#slide1"><img src="images/portada1.jpg" alt="REVISA NUESTRO CALENDARIO"></a>
    </li>
	...
	<div class="new">
		<div class="container">
			<div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
				<h3 class="title"><span>Nuestra Liga</span></h3>
