<%-- 
    Document   : calendario
    Created on : May 30, 2018, 10:56:03 AM
    Author     : AGutierrez
--%>
...
<%@page import="com.ipn.mx.DAO.PartidoDAOImpl"%>
    ...
    <body>
        ...
        <header id="header">
            ...
            <div class="new">
                <div class="container">
                    <div class="title-info wow fadeInUp animated" data-wow-delay=".5s">
                        <h3 class="title"><span>Caldario de juegos Temporada 2018</span></h3>
            ...
            <table>
                ...
                <%
                    PartidoDAOImpl unPartidoDAOImpl = new PartidoDAOImpl();
                    List<Partido> partidos = new ArrayList<Partido>();
                    partidos = unPartidoDAOImpl.load(Conexion.crearConexion());
                ...
                <tr>
                    ...
                    <td>
                        <%=unPartido.getEquipolocal()%>
                    </td>
                    <td>
                        <%=unPartido.getEquipovisitante()%>
                    </td>
                    <td>
                        <%=unPartido.getFecha()%>
                    </td>
