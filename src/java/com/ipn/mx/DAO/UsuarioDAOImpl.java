...
public class UsuarioDAOImpl {
    ...
    public Usuario LoadUsuario(String username,String pass,Connection conn) throws SQLException{
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
            ...
            if (results!=null){
                ...
                unUsuario.setCategoriausuario(String.valueOf(results[4]));
                unUsuario.setNombreusuario(String.valueOf(results[3]));
                unUsuario.setCurp(String.valueOf(results[0]));
                return unUsuario;
            }
